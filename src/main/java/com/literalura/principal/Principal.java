...
public class Principal {
    ...
    private Datos getDatosLibros() {
        ...
        datosLibros.resultados().forEach(libro -> {
    ...
    private void buscarLibroPorTitulo() {
        ...
        if (!datos.resultados().isEmpty()) {
            ...
            System.out.println("Creando libro con descargas: " + datosLibros.numeroDeDescargas());
            ...
            if (libroEncontrado != null) {
                ...
                if (autorEncontrado != null) {
                    ...
                    System.out.println("Guardando en BD: " + nuevoLibro);
